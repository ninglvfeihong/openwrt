/*
 *  Baiya Technology BY-SHS board support
 * 
...
static void __init by_shs_setup(void)
{
...
MIPS_MACHINE(ATH79_MACH_EL_MINI, "BY-SHS", "Baiya technoloy BY-SHS",
	     by_shs_setup);
